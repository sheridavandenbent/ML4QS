...
class CreateDataset:
    ...
    def add_numerical_dataset(self, file, timestamp_col, value_cols, aggregation='avg', prefix='', datetimefix=False):
    ...
    def add_event_dataset(self, file, start_timestamp_col, end_timestamp_col, value_col, aggregation='sum', datetimefix=False):
        print(f'Reading data from {file}')
