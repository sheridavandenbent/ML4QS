...
DATASET_PATH = Path(sys.argv[1] if len(sys.argv) > 1 else './intermediate_datafiles/our_data/')
...
for milliseconds_per_instance in GRANULARITIES:
    ...
    dataset.add_numerical_dataset('added_timestamps_result.csv', 'timestamps',
