...
RESULT_FNAME = sys.argv[2] if len(sys.argv) > 2 else 'chapter5_result_ours.csv'
...
dataset_knn = clusteringNH.k_means_over_instances(copy.deepcopy(dataset), ['mag_phone_x', 'mag_phone_y', 'mag_phone_z'], k, 'default', 50, 50)
