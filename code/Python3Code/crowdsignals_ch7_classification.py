...
DATASET_FNAME = 'chapter5_result_userAcceleration.csv'
...
basic_features = ['attitude.roll', 'attitude.pitch', 'attitude.yaw', 'gravity.x', 'gravity.y', 'gravity.z',
...
selected_features = ['rotationRate.z_temp_std_ws_180', 'userAcceleration.z_temp_std_ws_180',
                     'gravity.x_freq_0.0_Hz_ws_100', 'userAcceleration.y_freq_0.0_Hz_ws_100',
...
#                      # converters={"col1": lambda x: x.strip("[]").replace("'","").split(", ")}
#                      )
# scores_over_all_algs = df.col1.apply(json.loads).tolist()
...
#         print("Feedforward neural network finished")
#
...
#     df = pd.DataFrame(data={"col1": scores_over_all_algs})
#     df.to_csv("file_temp.csv", sep=',', index=False)
#
